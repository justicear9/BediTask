...
$Settings_model->save_setting("login_as_client_item_purchase_code", $item_purchase_code);

//start installation
$sql = file_get_contents(PLUGINPATH . "$product/install/database.sql");
$sql = str_replace('Login_As_Client-ITEM-PURCHASE-CODE', $item_purchase_code, $sql);
