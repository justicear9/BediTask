...
class Login_As_Client_Updates extends Security_Controller {
    ...
    function index() {
        ...
        echo $this->template->view("Login_As_Client\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_setting("login_as_client_item_purchase_code");
