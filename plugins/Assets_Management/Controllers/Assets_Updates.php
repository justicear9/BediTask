...
class Assets_Updates extends Security_Controller {
    ...
    function __construct() {
        ...
        $this->product = "Assets_Management";
    ...
    function index() {
        ...
        echo $this->template->view("Assets_Management\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_setting("assets_management_item_purchase_code");
...
/* End of file Assets_Updates.php */
/* Location: ./plugins/Assets_Management/Controllers/Assets_Updates.php */