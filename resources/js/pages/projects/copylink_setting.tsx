                            ...
                            <CardContent className="p-6 space-y-6">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    {[
                                        ...
                                        { label: t('Est. Hours'), value: `${currentProject?.estimated_hours || 0}h`, icon: Clock, gradient: 'from-blue-50 to-indigo-50', iconGradient: 'from-blue-100 to-indigo-100', iconColor: 'text-blue-600' }
                                    ].map((item, i) => (
