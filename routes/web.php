...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware(['plan.access', 'plan.limits'])->group(function () {
        ...
        Route::post('contracts/{contract}/send-contract-email', [\App\Http\Controllers\ContractController::class, 'sendContractEmail'])->middleware('permission:contract_send_email')->name('contracts.send-contract-email');
